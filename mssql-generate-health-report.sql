...
DECLARE @subject       AS NVARCHAR(255)
	...
	SET @subject      = 'Health Report for ' + CONVERT(VARCHAR(50), SERVERPROPERTY('ServerName'));
...
EXEC [dbo].[MSSQLGenerateHealthReport] @profile_name = N'SQLAlerts'
                                     , @recipients   = N'pugah@bancoaliado.com'
									 , @format       = N'mail'
GO